...
public class Acceso {
    ...
    public static Connection getConexion(){
        ...
        try{
          ...
          cn=DriverManager.getConnection("jdbc:derby://localhost:1527/ProyectoHotelBD","unw","123");
    ...
    try {
        ...
        if (cn == null) {
            ...
            if (numObt != null && numObt.length() >= 3) {
                ...
                numGen = "A00001"; // Default value or handle appropriately
            }
        }
    } catch (SQLException e) {
        numGen = null;
